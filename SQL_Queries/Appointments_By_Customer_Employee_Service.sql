SELECT "Appointments".appointment_id, date, time, customizations, service_description, position, employee_first_name, customer_first_name, customer_last_name
FROM "Appointments"
...
WHERE "Appointments".date >= '2024-02-26'::date AND "Appointments".date <= '2024-03-03'::date
